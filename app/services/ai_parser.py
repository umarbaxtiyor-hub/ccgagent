...
async def parse_expense_text(
    ...
    prompt = (
        ...
        "bo'lsa, quantity=1 deb ol (masalan \"12 kishilik stol\" - bitta stol, quantity=1). Xuddi shunday "
        "\"2 qavat uchun\" kabi maqsad/joy izohini ham miqdor deb qabul qilma (\"2 qavat uchun divan\" - "
        "bu nechta divan ekanini bildirmaydi, qayerda ishlatilishini bildiradi) - bunday holatda ham "
        "aniq son yo'q bo'lsa quantity=1 deb ol, taxmin qilib boshqa son yozma. Bunday holatlarda "
        "description'ni QISQA va toza tut (faqat buyum nomi, masalan \"Majlis stoli\") - \"12 kishilik\", "
        "\"2-qavat uchun\" kabi qo'shimcha tafsilotlarni description'ga qo'shib o'tirma, chunki foydalanuvchi "
        "yozgan asl xabarning to'liq matni allaqachon alohida saqlanadi va Google Sheetsga ham tushadi.\n\n"
